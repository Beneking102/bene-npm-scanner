  ...
  return (
    ...
    >
      <button
        ...
        onClick={isClean ? undefined : () => setOpen((o) => !o)}
        aria-expanded={isClean ? undefined : open}
        aria-disabled={isClean}
      >
        <span className={`w-2 h-2 rounded-full shrink-0 ${isClean ? "bg-[#00e541]" : "bg-red-500 animate-pulse"}`} />
